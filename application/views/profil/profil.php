        ...
        <div class="col-md-4">
          ...
          <div class="box box-primary">
            <div class="box-body box-profile">
              <img class="profile-user-img img-responsive img-circle" src="<?=base_url()?>assets/back-end/dist/img/jp.jpg" alt="User profile picture">
             ...
             <strong><i class="fa fa-book fa-user margin-r-5"></i> level</strong>
              ...
              <p>jangan lupa makan siang malam dan tidur ok.</p>
            </div>
          </div>
            </div>
          </div>
